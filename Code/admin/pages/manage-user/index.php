...
$table = isset($_GET['table']) ? $_GET['table'] : 'all-user';
$page = isset($_GET['page']) ? $_GET['page'] : '1';
$numrow = isset($_GET['numrow']) ? $_GET['numrow'] : '10';
$sortby = isset($_GET['sortby']) ? $_GET['sortby'] : 'manguoidung asc';
// Show data
echo "<script>showUserData('$table', $page, $numrow, '$sortby')</script>";
?>
<!-- Modal Start-->
...
<div class="container-fluid main mx-0 row px-0 position-fixed" style="overflow: hidden;">
  <div class="row m-0 mt-0 px-0">
    <div class="col-md-12 px-0 mt-0 mx-0" style="background-color: #299be4;">
      <h1></h1>
    </div>
