    ...
    <div class="row me-0">
        ...
        <div class="col-lg col-md-3 my-1 mx-2 card text-center shadow dashboard-card">
            <div class="card-body">
                <?php
                //Sql Query 
                $sql_bills = "SELECT SUM(tongTien) as thuNhap FROM phieudangkitour, tour WHERE phieudangkitour.maTour = tour.maTour and phieudangkitour.tinhTrang = 3 and tour.maCongTy = '{$_SESSION['partnerAccount']}'";
                //Execute Query
                ...
                ?>
                <h2 class=" ms-1card-title d-inline"><?php echo $income ?></h2>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <th scope="row"><?php echo $rows_recent_bills['maPhieuTour'] ?></th>
                        <td><?php echo $rows_recent_bills['tongTien'] ?></td>
                        <td><?php //echo $rows_recent_bills['']; ?> </td>
                        <td><?php echo $rows_recent_bills['tinhTrang'] ?></td>
                    </tr>
