...
if (isset($_POST['btnAddTour'])) {
    ...
    //Insert to database
    $sql_add_tour = "INSERT INTO `tour` (`id`, `maTour`, `tenTour`, `hinhAnh`, `ngayKhoiHanh`, `ngayKetThuc`, `diemKhoiHanh`, `diemKetThuc`, `loaiHinh`, `moTa`, `maCongTy`) VALUES (NULL, '$tourID', '$tourTitle', '$tourImage', '$tourDepartureDay', '$tourEndDate', '$tourPlaceDeparture', '$tourPlaceDestination', '$tourType', '$tourDescription', '{$_SESSION['partnerAccount']}');";
    $inser_tour = $conn->query($sql_add_tour);
    ...
    header("location:" . SITEURL . "partners/");
}
