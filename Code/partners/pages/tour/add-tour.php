...
<div class="container-fluid px-0">
    <div class="row me-0">
        ...
        <div class="col-md-12 add-tour shadow px-0">
            ...
            <div class="col-md-12 input-group row">
                <!-- Form input -->
                <form class="col-md-12 mb-4" action="proccess-add-tour.php" method="post" enctype="multipart/form-data" autocomplete="off">
