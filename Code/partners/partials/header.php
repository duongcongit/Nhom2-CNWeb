...
if($partnerAvatarName == ""){
    $partnerAvatarName = "anh-chan-dung.jpg";
}
...
<head>
  ...
  <link rel="stylesheet" href="<?php echo SITEURL ?>partners/css/style.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
  <script src="<?php echo SITEURL ?>partners/js/script.js"></script>
</head>
...
<body>
  ...
  <div class="container sidebar off-sidebar offcanvas offcanvas-start mt-0" id="offcanvassidebar">
    <div class="sidebar-avatar">
      <img class="avatar" src="<?php echo SITEURL."admin/images/$partnerAvatarName" ?>" alt="">
    ...
    <div class="sidebar-menu">
      <ul class="">
        <li>
          <a href="<?php echo SITEURL . "partners/" ?>" class="nav-link link-dark <?php echo ($current_page_folder == "partners" ? "active" : "") ?>">
        ...
        <hr>
        <li>
          <a href="<?php echo SITEURL . "partners/pages/appointment/" ?>" class="nav-link link-dark <?php echo ($current_page_folder == "appointment" ? "active" : "") ?>">
        ...
        <li>
          ...
          <ul class="tour-show <?php echo ($current_page_folder == "tour" ? "show" : "") ?>">
            <li>
              <a href="<?php echo SITEURL . "partners/pages/tour/add-tour.php" ?>" class=" <?php echo ($currentFileName == "add-tour.php" ? "active" : "") ?>">Thêm tour</a>
            </li>
            <li><a href="<?php echo SITEURL . "partners/pages/tour/index.php" ?>" class=" <?php echo ($current_page_folder == "tour" && $currentFileName == "index.php" ? "active" : "") ?>">Danh sách tour</a></li>
          </ul>
        </li>
        <hr>
        <li>
          <a href="<?php echo SITEURL . "partners/pages/bill/" ?>" class="nav-link link-dark <?php echo ($current_page_folder == "bill" ? "active" : "") ?>">
        ...
        <hr>
        <li>
          <a href="<?php echo SITEURL . "partners/pages/bill/" ?>" class="nav-link link-dark <?php echo ($current_page_folder == "" ? "active" : "") ?>">
        ...
        <hr style="width: 100%;" ;>
        <li>
          <a href="<?php echo SITEURL . "partners/pages/profile/" ?>" class="nav-link link-dark <?php echo ($current_page_folder == "profile" ? "active" : "") ?>">
            <i class="bi bi-person"></i>
            <span class="sidebar-item-text">Hồ sơ</span>
          </a>
        </li>
        <li>
          <a href="<?php echo SITEURL . "partners/pages/support/" ?>" class="nav-link link-dark <?php echo ($current_page_folder == "support" ? "active" : "") ?>">
      ...
      <div class="col-md-12 px-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="container-fluid px-2">
            ...
            <img class="me-auto" src="<?php echo SITEURL ?>partners/images/logo.png" height="40px">
            </button>
