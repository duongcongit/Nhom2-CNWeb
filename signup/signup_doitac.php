    ...
    <div class="container-fluid login-page">
        <div class="row">
            ...
            <div class="col-md-6 login-form-container">
                <form class="form-signin" action="process-register-doitac.php" method="POST">
                    <h1 class="h3 mb-3 font-weight-normal text-center">Đăng Kí</h1>
                    <label for="inputTenCongTy" class="sr-only">Tên côngty</label>
                    <input type="text" id="inputTenCongTy" name="TenCongTy" class="form-control" placeholder="Tên công ty đối tác" required autofocus>
